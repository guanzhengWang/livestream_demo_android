...
public class EaseUserUtils {
    ...
    public static void setUserAvatar(Context context, String username, ImageView imageView){
        ...
        if(user != null && user.getAvatar() != null){
            setUserAvatarbyPath(context,user.getAvatar(),imageView,null);
    ...
    public static void setUserAvatarbyPath(Context context, String path, ImageView imageView,String groupId){
